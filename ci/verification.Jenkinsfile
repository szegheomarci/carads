pipeline {
    ...
    environment {
        testMySQL_address = credentials('your-username-password-credential-id')
        testMySQL_user = credentials('your-username-password-credential-id')
        testMySQL_dbname = 'default'
    }
